...
@EnableJpaRepositories(basePackages = "ufc.persistence")
...
public class JPAConfig {
    ...
    public DataSource dataSource() throws SQLException {
        ...
        String jdbcUrl = enviroment.getProperty("jdbc.url");
        String username = enviroment.getProperty("jdbc.username");
        String password = enviroment.getProperty("jdbc.password");
    ...
    public EntityManagerFactory entityManagerFactory() throws SQLException {
        ...
        factory.setPackagesToScan("ufc.persistence.entity");
    ...
    private Properties jpaProperties() {
        String hibenrateDialect = enviroment.getProperty("jdbc.hibernate.dialect");
        String hibenrateHbm2ddlAuto = enviroment.getProperty("jdbc.hibernate.hbm2ddl");
